...
library(readxl)
havaK <- read_excel("C:\\bys\\havaK.xlsx")
head(havaK, n = 10)
```
...
library
colnames(havaK)[2] <- "PM10"
colnames(havaK)[3] <- "SO2"
havaK$Time[is.na(havaK$Time)] <- 0
